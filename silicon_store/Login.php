	...
	<div class="container">
		...
		<div class="page">
				<div class="row justify-content-center">
					<div class="col-auto">
						<h2 class="h2">Log In</h2><br>
						
						<form action = "php/login_check.php" onsubmit = "return validate()" method = "POST">
						...
						<input type="button" id="logoutbtn" value="log out" onclick="deleteCookie()"><br>
					</div>
				</div>
				
				<div class="row justify-content-center">
					<div class="col-auto">
						<br><a href="SignUp.php">New? Sign up here</a>
					</div>
				</div>
		</div>
